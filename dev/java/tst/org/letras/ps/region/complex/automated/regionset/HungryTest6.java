...
public class HungryTest6 extends AbstractDispatchTest {

	public HungryTest6() throws Exception {
		super(new RegionDocumentRegionSet(RegionDocument.fromFile(new File("automated/htest6.regions"))),
				"automated/htest6.pen");
	}
	
	@Override
	protected void setupConsumers() {
		
		String main = "htest6_main";
		String sub1 = "htest6_sub1";
		String sub11 = "htest6_sub1_1";
		...
		consumeEvents(RegionEvent.TRACE_START, mainArray, sub11Array);
		consumeSamples(main, sub11);
		consumeEvents(RegionEvent.TRACE_END, mainArray, sub11Array);
		consumeEvents(RegionEvent.TRACE_START, mainArray, sub1Array);
		consumeSamples(main, sub1);
		consumeEvents(RegionEvent.TRACE_END, mainArray, sub1Array);
