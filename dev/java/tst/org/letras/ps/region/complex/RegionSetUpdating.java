...
public class RegionSetUpdating implements IDigitalInkConsumer {
	...
	public void testRegionUpdating() throws Exception {
		...
		RegionSet rs = new RegionSet("regionset://1", Arrays.asList(region1.getRegionData()));
		Mundo.registerService(rs);
		...
		rs.removeRegion(region1.getRegionData());
		rs.addRegion(region2.getRegionData());
		Thread.sleep(1000);
